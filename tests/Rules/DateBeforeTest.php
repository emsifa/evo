...
use Emsifa\Evo\Rules\DateBefore;
...
class DateBeforeTest extends TestCase
{
    ...
    public function testOverrideMessage()
    {
        ...
        $accepted = new DateBefore('today', $message);
    ...
    public function testFallbackMessage()
    {
        ...
        $this->assertEquals(__('validation.before', ['date' => date_create('today')->format('Y-m-d H:i:s')]), $accepted->message());
    }
}
